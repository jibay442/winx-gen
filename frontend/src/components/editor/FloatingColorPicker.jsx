  ...
  return (
    ...
    >
      ...
      <p className="text-[10px] text-purple-400 mt-2 text-center">
        Le personnage affichera la variante la plus proche
      </p>
      <div className="flex items-center gap-2 mt-2">
        <div className="w-8 h-8 rounded-lg border border-gray-200 flex-shrink-0" style={{ background: currentColor }} />
        <input type="text" value={currentColor.toUpperCase()}
          onChange={(e) => { const v = e.target.value; if (/^#[0-9A-Fa-f]{0,6}$/.test(v)) setCharacterProp(charKey, v) }}
